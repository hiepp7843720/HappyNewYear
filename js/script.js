...
const WISH_MESSAGES = [
	...
	"Năm mới bình an",
	"Chúc mọi điều ước của béiu đều trở thành hiện thực ✨",
	"Chúc gia đình béiu luôn bình an và hạnh phúc ❤️",
	"Chúc béiu luôn khỏe mạnh và tràn đầy năng lượng 💪",
	"Chúc công việc thuận lợi, thăng tiến không ngừng 🚀",
	"Chúc béiu luôn mỉm cười và yêu đời mỗi ngày 😊",
	"Chúc béiu gặp nhiều may mắn và niềm vui 🎉",
];
